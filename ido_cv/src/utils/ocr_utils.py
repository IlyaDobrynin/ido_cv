...
class LabelConverter(object):
    ...
    def __init__(self, alphabet: str, ignore_case: bool = False):
    ...
    def encode(self, labels):
        ...
        Returns:
            [length_0 + length_1 + ... length_{n-1}]: encoded labels.
            [n]: length of each labels.
        """
        if isinstance(labels, str):
            ...
            raise ValueError(
                f"Unsupported type of input images: {type(labels)}"
            )
    ...
    def decode(self, probs, length, raw=False, strings=True):
        ...
        Args:
            probs = torch.IntTensor [length_0 + length_1 + ...
